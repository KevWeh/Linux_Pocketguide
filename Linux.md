...
| Debian                           |  | Desktop + Server | Ja                    | dpgk / apt      | sudo apt            | Desktop: GUI + CLI / Server: CLI |
| CentOS                           |  | Desktop + Server | Ja                    | dpgk / apt      | sudo apt            | Desktop: GUI + CLI / Server: CLI |
| RedHat Enterprise Edition (RHEL) |  | Desktop + Server | Ja                    | dpgk / apt      | sudo apt            | Desktop: GUI + CLI / Server: CLI |
| Kali Linux                       |  | Desktop + Server | Ja                    | dpgk / apt      | sudo apt            | Desktop: GUI + CLI / Server: CLI |
| Arch                             |  | Desktop + Server | Ja                    | dpgk / apt      | sudo apt            | Desktop: GUI + CLI / Server: CLI |
| Linux Mint                       |  | Desktop + Server | Ja                    | dpgk / apt      | sudo apt            | Desktop: GUI + CLI / Server: CLI |
